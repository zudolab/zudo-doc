...
`$...$`、`$$...$$`、および `` ```math `` フェンスは **zfb では非対応です**。zfb の Rust MDX エミッタはこれらの構文を処理しません — 代わりに `<MathBlock latex="..." />` を使用してください（[`pages/lib/_math-block.tsx`](https://github.com/zudolab/zudo-doc/blob/main/pages/lib/_math-block.tsx) を参照）。

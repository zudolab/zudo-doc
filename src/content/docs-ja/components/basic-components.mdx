...
| `--zdc-doc-link-decoration` | `content-link` | `underline` | Text decoration of prose links only (`ContentLink`, `a.text-accent.underline`); chrome links are unaffected. Set to `none` to remove underlines. |
...
詳しい解説 — 所有権の逆転という考え方、3層トークン戦略における位置づけ、クロームトークン（カード半径・目次の幅・ナビのアクティブスタイル）、そしてDesign Token Panelで編集できない理由 — は[コンポーネントトークン](../reference/component-tokens.mdx)を参照してください。

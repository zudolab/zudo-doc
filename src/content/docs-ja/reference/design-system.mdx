...
`hover:underline focus-visible:underline` のペアが正規形です。必ず両方を書き、片方だけにはしないでください。実装例：`packages/zudo-doc-v2/src/header/header.tsx`、`src/components/site-tree-nav.tsx`、`packages/zudo-doc-v2/src/footer/footer.tsx`。

...
Doc History Serverは`packages/doc-history-server/`にあるサブパッケージで、[ドキュメント履歴](/ja/docs/guides/doc-history)機能のすべてのgit履歴抽出を処理します。コストの高いgit操作をサイトビルドから分離するために、zfbビルドパイプラインから抽出されました。

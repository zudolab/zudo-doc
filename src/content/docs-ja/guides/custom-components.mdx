...
- コンテンツヘルパー: `Details`、`HtmlPreview`、`CodeGroup`、`Tabs`、`TabItem`、`Island`、`PresetGenerator`、`Asset`、`AssetCode`
...
`Asset` と `AssetCode` は、アセットマニフェストに基づくカードとソース抜粋を表示するパッケージ標準コンポーネントです。記述方法とマニフェストを生成する設定は [アセットビューアー](./asset-viewer.mdx)を参照してください。

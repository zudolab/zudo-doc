...
利用可能なスキームの一覧、プレビュー、カスタムスキームの追加手順については[カラーガイド](../reference/color.mdx)を参照してください。
...
4つのタブ構成やJSONエクスポートワークフローについては[Design Token Panelリファレンス](../reference/design-token-panel.mdx)を参照してください。

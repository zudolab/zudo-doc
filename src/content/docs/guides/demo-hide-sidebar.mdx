...
- [Demo: Hide Table of Contents](/docs/guides/demo-hide-toc/) — hides the right-side TOC
- [Demo: Hide Sidebar & Table of Contents](/docs/guides/demo-hide-both/) — hides both panels

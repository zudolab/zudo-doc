---
title: Color
description: zudo-doc's three-tier color strategy, ANSI palette, color schemes, and customization.
sidebar_position: 3
---
...
## Tier 1: The ANSI 16-Color Palette

zudo-doc's color system is built on the **ANSI 16-color palette** — the same standard used by terminal emulators like Ghostty, iTerm2, and Alacritty. Each color scheme provides values for 16 indexed color slots plus background, foreground, and selection colors.
...
zudo-doc ships with 40+ color scheme presets including:

- **Dracula** — Purple-accented dark theme
- **Catppuccin Mocha / Frappe / Macchiato / Latte** — Warm pastel themes
- **Nord** — Cool blue-gray dark theme
- **TokyoNight** — Deep blue dark theme
- **Gruvbox Dark / Light / Material** — Warm retro themes
- **Atom One Dark / Light** — Neutral themes
- **Solarized Dark / Light** — Ethan Schoonover's precision themes
- **Monokai Pro / Remastered / Vivid / Soda** — Monokai variants
- **Material Ocean / Darker / Dark / Light** — Material Design themes
- **Rose Pine / Moon / Dawn** — Elegant themes
- **GitHub Dark / Dimmed / Light** — GitHub-style themes
- **Everforest Dark / Light** — Nature-inspired themes
- **Kanagawa Wave / Dragon** — Japanese wave art themes
- **Nightfox / Carbonfox / Dawnfox / Dayfox / Duskfox** — Fox family themes
- **Night Owl**, **Poimandres**, **Vesper**, **Doom One**, **Snazzy**, **VS Code Dark+**, and more

See `src/config/color-schemes.ts` for the full list.
...
- `palette` — 16-element tuple (ANSI colors 0–15)
...
<Tip>
Ghostty terminal themes use the same ANSI color slots. You can copy values from any Ghostty theme file directly into a new color scheme entry — the palette indices match 1:1.
</Tip>

...
See the [Color guide](../reference/color.mdx#adding-a-custom-color-scheme) for the ramp-native color model and instructions on adding a custom scheme.
...
See the [Design Token Panel reference](../reference/design-token-panel.mdx) for a full tour of the five tabs and the JSON export workflow.

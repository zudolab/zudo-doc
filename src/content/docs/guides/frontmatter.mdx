...
<Info>
See the [live demo](/docs/guides/demo-hide-sidebar/) to experience this layout option in action.
</Info>
...
<Info>
See the [live demo](/docs/guides/demo-hide-toc/) to experience this layout option in action.
</Info>
...
See the [live demo](/docs/guides/demo-hide-both/) to see both options combined.
</Tip>

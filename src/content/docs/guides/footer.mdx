...
The layout is responsive: a single column on mobile, two columns on small screens, and auto-fit columns on large screens. See `packages/zudo-doc-v2/src/footer/footer.tsx` for implementation details.

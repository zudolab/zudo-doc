...
When scaffolding a new project with `create-zudo-doc`, check the **"Avoid robots indexing"** checkbox in the interactive [Setup Preset Generator](../getting-started/setup-preset-generator.mdx). This emits `noindex: true` in the generated `settings.ts`.

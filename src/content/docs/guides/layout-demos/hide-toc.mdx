...
If you want readers to make that call themselves rather than fixing it per page, enable the [`tocToggle`](../configuration.mdx#site-settings-toctoggle) setting — it puts a persistent show/hide control on every page.

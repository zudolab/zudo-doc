...
See the [Frontmatter reference](../frontmatter.mdx#fields-hide_sidebar) for full documentation.

## See Also

- [Hide Sidebar](./hide-sidebar.mdx) — hides just the left sidebar
- [Hide Table of Contents](./hide-toc.mdx) — hides just the right-side TOC

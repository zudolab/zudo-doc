...
sidebar_label: Hide Sidebar & TOC
...
- [Hide Sidebar](/docs/guides/layout-demos/hide-sidebar/) — hides just the left sidebar
- [Hide Table of Contents](/docs/guides/layout-demos/hide-toc/) — hides just the right-side TOC

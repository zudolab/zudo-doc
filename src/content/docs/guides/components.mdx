...
Admonitions are callout blocks for highlighting important information. Each type has a distinct color from the ANSI palette and a default title that can be overridden with the `title` prop.
...
- Internal link: [Writing Docs](/docs/guides/writing-docs)

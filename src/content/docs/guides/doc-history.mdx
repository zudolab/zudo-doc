...
Once enabled, each doc page shows a **History** button inside the [body foot util area](./body-foot-util-area.mdx) — the small right-aligned strip between the article and the footer.

...
`$...$`, `$$...$$`, and `` ```math `` fences are **not supported** in zfb. The zfb Rust MDX emitter does not process those syntaxes — use `<MathBlock latex="..." />` instead (see [`pages/lib/_math-block.tsx`](https://github.com/zudolab/zudo-doc/blob/main/pages/lib/_math-block.tsx)).

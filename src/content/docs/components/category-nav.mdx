...
<Info>
This component is **not** globally available in MDX content. Import it in category index files where you need a child page listing.
</Info>
...
- **Hover effect** — card text underlines on hover for clear interactivity

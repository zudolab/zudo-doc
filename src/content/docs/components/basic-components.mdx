...
Fenced code blocks use zfb's build-time semantic class-mode highlighter. Specify the language after the opening backticks. See the [Code Blocks](./code-blocks.mdx) page for the full rundown.

...
Unsupported languages fall back to plain text (no highlighting). This is a smaller subset than the [full language list](./basic-components.mdx#supported-languages) available in standard code blocks.

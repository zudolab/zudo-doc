...
<Info>
This component is **not** globally available in MDX content. It must be imported directly in Astro page templates. See it in action on the [home page](/docs/getting-started).
</Info>

## Live Example

Visit the [home page](/) to see `SiteTreeNav` rendered with the full documentation tree.

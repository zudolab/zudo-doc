...
| `packages/create-zudo-doc/src/astro-config-gen.ts` | Programmatic `astro.config.ts` generator |
| `packages/create-zudo-doc/src/content-config-gen.ts` | Programmatic `content.config.ts` generator |

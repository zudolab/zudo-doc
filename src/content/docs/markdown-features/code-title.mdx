...
- The copy button visible in the UI is injected by client-side JavaScript and is not part of the SSR output. See [Code Enrichment](./code-enrichment.mdx) for the opt-in feature that adds the copy button and diff/line-highlight decorations.

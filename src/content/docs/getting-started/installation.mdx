...
- **Single scheme** — one fixed color scheme for the entire site. Over 30 schemes are available, including Dracula, Nord, TokyoNight, and more.
...
|---------|---------|-------------|
| i18n (English + Japanese) | On | Multi-language support with mirrored content directories |
...
| Color scheme preview | Off | Runtime color scheme switcher in the site header |

### Package Manager

Choose your preferred package manager: pnpm (recommended), npm, yarn, or bun. Dependencies are installed automatically after scaffolding.

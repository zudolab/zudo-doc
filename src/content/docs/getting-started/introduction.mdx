...
- **Color scheme presets** — ANSI 16-color palettes (Dracula, Nord, Tokyo Night, and more)
...
The color scheme system is based on the ANSI 16-color palette standard — the same palette used by terminal emulators. By swapping a single preset, the entire site's appearance changes.
...
Then open [http://localhost:4321](http://localhost:4321) to see your docs.

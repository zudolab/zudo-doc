...
You can also configure this option when scaffolding a new project with the [Setup Preset Generator](../getting-started/setup-preset-generator.mdx) or the [create-zudo-doc CLI](./create-zudo-doc.mdx) using `--cjk-friendly` / `--no-cjk-friendly`.

...
- The FOUC-prevention script injected into `<head>` by the doc layout (`@takazudo/zudo-doc/doclayout`) performs the same v2-then-v1 lookup so saved colors apply before first paint on old devices too.

...
For paragraphs, lists or a longer introduction, use [home.introMarkdown](../guides/configuration.mdx#home). It renders a separate compact prose section below the identity; `homeExtras` and `extras` retain their inline navigation semantics.

...
The pair `hover:underline focus-visible:underline` is the canonical form — always add both, never one without the other. Precedents: `packages/zudo-doc-v2/src/header/header.tsx`, `src/components/site-tree-nav.tsx`, `packages/zudo-doc-v2/src/footer/footer.tsx`.

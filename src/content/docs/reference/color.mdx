...
The `ColorSchemeProvider` component (`packages/zudo-doc/src/theme/color-scheme-provider.tsx`) reads the active color scheme and injects CSS custom properties on `:root` at build time:

...
The `ColorSchemeProvider` component (`packages/zudo-doc-v2/src/theme/color-scheme-provider.tsx`) reads the active color scheme and injects CSS custom properties on `:root` at build time:

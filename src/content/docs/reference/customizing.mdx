...
The two scaffold stubs (`pages/index.tsx`, `pages/docs/[[...slug]].tsx`) are themselves ordinary host pages using this precedence; you can expand them or add siblings. See [Routing Conventions](../develop/routing-conventions.mdx) for how routes are enumerated and shadowed.

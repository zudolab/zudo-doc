...
export function Toc({ headings }: TocProps) {
  ...
  return (
    <nav
      ...
      className="hidden xl:block w-[280px] shrink-0 sticky top-[3.5rem] self-start z-10 pt-vsp-xl lg:pt-vsp-2xl max-h-[calc(100vh-3.5rem)] overflow-y-auto"
    >
          ...
          return (
            ...
            >
              <a
                ...
                className={`block py-vsp-2xs text-small leading-snug transition-colors ${
                  isActive

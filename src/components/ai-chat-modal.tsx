...
export default function AiChatModal({ basePath }: AiChatModalProps) {
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 m-0 h-dvh max-h-none w-dvw max-w-none border-none bg-surface p-0 text-fg backdrop:bg-bg/80 lg:static lg:inset-auto lg:m-auto lg:h-[90vh] lg:max-h-[90vh] lg:w-[90vw] lg:max-w-[52.5rem] lg:border lg:border-muted lg:rounded-[0.75rem]"
    >

...
export default function AiChatModal({ basePath }: AiChatModalProps) {
  ...
  return (
    <dialog
      ...
      className="m-0 flex h-full w-full flex-col border border-muted bg-surface p-0 backdrop:bg-bg/80 lg:m-auto lg:h-[min(80vh,48rem)] lg:w-[min(90vw,40rem)] lg:rounded-sm"
      style={{
        color: "var(--color-fg)",
        position: "fixed",
        top: "50%",

...
| `.github/workflows/publish-create-zudo-doc.yml` | CI publish workflow (fires on draft publish) |
| `packages/create-zudo-doc/package.json` | Package version (must match the git tag) |

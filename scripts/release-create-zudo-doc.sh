...
echo ""
echo "Next steps:"
echo "  1. Fill in each package entry under src/content/docs/changelog/<package>/$NEW_VERSION.mdx"
echo "  2. Fill in each Japanese mirror under src/content/docs-ja/changelog/<package>/$NEW_VERSION.mdx"

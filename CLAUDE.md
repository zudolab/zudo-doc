...
- **No class string management utilities** (clsx, classnames, cn, etc.) — use plain template literals and ternaries for conditional classes. AI-driven development makes these readability helpers unnecessary.

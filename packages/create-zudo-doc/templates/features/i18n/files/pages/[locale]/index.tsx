...
// (`packages/zudo-doc/src/routes/locale-index.tsx`). No `extras` here — the
// showcase's `@Takazudo` brand link (#1453) is project-specific and is not
// part of the generated project's hero.

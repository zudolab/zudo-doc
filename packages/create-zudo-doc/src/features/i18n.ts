 ...
 * Astro cutover (#1736 / W7A). The pages are locale-agnostic — they iterate
 * `settings.locales` at build time, so no postProcess regex patching is
 * required for non-default languages.
 *

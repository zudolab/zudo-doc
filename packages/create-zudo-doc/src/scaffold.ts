 ...
 */
export const ZUDO_DOC_PIN = "^4.4.3";
...
function generatePackageJson(choices: UserChoices) {
  ...
  const deps: Record<string, string> = {
    ...
    "@takazudo/zfb": "0.1.0-next.92",
    "@takazudo/zfb-runtime": "0.1.0-next.92",
    "@takazudo/zfb-md-wasm": "0.1.0-next.92",
  ...
  if (choices.features.includes("docHistory")) {
    ...
    deps["@takazudo/zudo-doc-history-server"] = "^4.4.3";

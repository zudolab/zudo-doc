...
> **Eject CLI contract:** the per-component `zudo-doc eject <component>` swizzle CLI + `.zudo-doc.json` provenance marker are specified in [`docs/eject-contract.md`](./docs/eject-contract.md) (C0 #2359; implemented by C1 #2362).

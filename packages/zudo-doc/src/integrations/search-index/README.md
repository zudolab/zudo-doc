...
Cloudflare `@takazudo/zudo-doc-search-worker`. This is the zfb port of the Astro
...
import { emitSearchIndex } from "@takazudo/zudo-doc/integrations/search-index";
...
```ts
import { createSearchIndexDevMiddleware } from "@takazudo/zudo-doc/integrations/search-index";
...
export default defineConfig({
  ...
  plugins: [
    // …existing entries…
    {
      name: "@takazudo/zudo-doc/integrations/search-index",
      options: {
        docsDir: "src/content/docs",
        locales: { ja: { dir: "src/content/docs-ja" } },
        base: "",

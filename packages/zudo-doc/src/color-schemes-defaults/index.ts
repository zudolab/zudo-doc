...
import type { ColorScheme, Ramps, ModeMap } from "../color-scheme-utils.js";

/**
 * Shared Tier-1 ramps — identical across Default Light and Default Dark.
 * 5 base / 3 accent (#2602). The warm-neutral spine keeps hue 65; the accent
 * stops are the three tuned orange stops carried over from the 7-stop ramp
 * (old accent2/3/6, re-indexed). Index 0 = lightest.
 */
const ramps: Ramps = {
  base: [

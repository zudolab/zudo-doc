...
export const defaultTranslations: PresetTranslations = {
  en: {
    ...
    "appearance.systemHelper": "Follows device · currently {mode}",
    ...
    "asset.indexDescription":
      "Every file managed by the asset viewer. Open a file to see its viewer page, metadata, and the documents that reference it.",
  ...
  ja: {
    ...
    "appearance.systemHelper": "デバイスの設定に従います · 現在は{mode}",
    ...
    "asset.badge": "アセット",
    "asset.crumb": "アセット",
    "asset.indexBadge": "インデックス",
    "asset.indexDescription":
      "アセットビューアーで管理されているすべてのファイルです。ファイルを開くと、プレビュー、メタデータ、参照元のドキュメントを確認できます。",
    "asset.fileCount": "{count} ファイル",
    "asset.fileCountSingle": "{count} ファイル",
    "asset.folderCount": "{count} フォルダー",
    "asset.folderCountSingle": "{count} フォルダー",
    "asset.expandAll": "すべて展開",
    "asset.collapseAll": "すべて折りたたむ",
    "asset.indexEmpty": "アセットが見つかりません。",

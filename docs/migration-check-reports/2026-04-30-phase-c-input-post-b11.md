...
**Generated**: 2026-04-30T09:42:29.996Z
...
### 18. `asset-loss` — Asset removed or path changed (pattern: ba4949a965f36c34…) — 1 route(s)

**Signature**: `ba4949a965f36c34abc0ee374f58160988f63634a517f2d72d6aeb337d2ec438`
...
### 19. `asset-loss` — Asset removed or path changed (pattern: 9fe7c0cbd8122638…) — 1 route(s)

**Signature**: `9fe7c0cbd8122638265421ab557ca029e1c3455198cd90d841ed62b33e59926d`
...
### 20. `asset-loss` — Asset removed or path changed (pattern: ad06c10545af81c0…) — 1 route(s)

**Signature**: `ad06c10545af81c05d9946c3a659e072b2b1013da8c8eacb898bf138736726db`
...
### 18. [migration-check] asset-loss: Asset removed or path changed (pattern: ba4949a965f36c34…) (1 route(s))

**gh issue create command:**

```
gh issue create --title "[migration-check] asset-loss: Asset removed or path changed (pattern: ba4949a965f36c34…) (1 route(s))" --body $'**Category**: asset-loss
**Routes affected**: 1
**Signature**: `ba4949a965f36c34abc0ee374f58160988f63634a517f2d72d6aeb337d2ec438`
**Description**: Asset removed or path changed (pattern: ba4949a965f36c34…)
...
### 19. [migration-check] asset-loss: Asset removed or path changed (pattern: 9fe7c0cbd8122638…) (1 route(s))

**gh issue create command:**

```
gh issue create --title "[migration-check] asset-loss: Asset removed or path changed (pattern: 9fe7c0cbd8122638…) (1 route(s))" --body $'**Category**: asset-loss
**Routes affected**: 1
**Signature**: `9fe7c0cbd8122638265421ab557ca029e1c3455198cd90d841ed62b33e59926d`
**Description**: Asset removed or path changed (pattern: 9fe7c0cbd8122638…)
...
### 20. [migration-check] asset-loss: Asset removed or path changed (pattern: ad06c10545af81c0…) (1 route(s))

**gh issue create command:**

```
gh issue create --title "[migration-check] asset-loss: Asset removed or path changed (pattern: ad06c10545af81c0…) (1 route(s))" --body $'**Category**: asset-loss
**Routes affected**: 1
**Signature**: `ad06c10545af81c05d9946c3a659e072b2b1013da8c8eacb898bf138736726db`
**Description**: Asset removed or path changed (pattern: ad06c10545af81c0…)
